package io.github.wesleyosantos91.infrastructure.springdoc;
...
public class SpringDocConfig {
    ...
    public OpenAPI openAPIDefinition() {
        ...
        final Info info = new Info()
                ...
                .description("O microserviço API Cadastro de Pessoas gerencia o cadastro, atualização, "
                        + "busca e exclusão de registros de pessoas de forma eficiente e segura.")
    ...
    private License descriptionLicense() {
        return new License()
                .name("License")
                .url("https://github.com/wesleyosantos91/TechLabProjects/blob/main/LICENSE");
    }
    ...
    private Map<String, Schema> gerarSchemas() {
        return ModelConverters.getInstance().read(ErrorResponse.class);
    }
    ...
    private Map<String, ApiResponse> gerarResponses() {
        ...
        final Content content = new Content()
                .addMediaType(APPLICATION_JSON_VALUE,
                        new MediaType().schema(new Schema<ErrorResponse>().$ref("ErrorResponse")));
